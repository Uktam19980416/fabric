  ...
  return (
    <div className="max-xl:px-2">
      <div className="container w-full max-w-[1440px] mx-auto max-sm:px-2 max-sm:w-full rounded-3xl mt-28 relative">
        ...
        <div className="bg-custom-gradient-3 px-10 relative rounded-3xl py-10 shadow-custom-lg hover:shadow-custom-hover transition-shadow duration-300">
